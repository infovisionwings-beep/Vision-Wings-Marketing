      ...
      <div className="max-w-[1280px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div className="grid grid-cols-2 gap-8 col-span-1 md:col-span-2 lg:col-span-3 lg:grid-cols-3">
          <div className="flex flex-col gap-2">
            ...
            <Link href="#strategy" className="text-body hover:text-bronze-300 transition-colors w-fit py-2" data-interactive>Brand Strategy</Link>
            <Link href="#design" className="text-body hover:text-bronze-300 transition-colors w-fit py-2" data-interactive>Visual Identity</Link>
            <Link href="#growth" className="text-body hover:text-bronze-300 transition-colors w-fit py-2" data-interactive>Growth Marketing</Link>
            <Link href="#web" className="text-body hover:text-bronze-300 transition-colors w-fit py-2" data-interactive>Digital Experience</Link>
          </div>
          ...
          <div className="flex flex-col gap-2 col-span-2 lg:col-span-1">
            ...
            <a href="mailto:hello@visionwing.agency" className="text-body hover:text-bronze-300 transition-colors w-fit py-2" data-interactive>hello@visionwing.agency</a>
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-body hover:text-bronze-300 transition-colors w-fit py-2" data-interactive>LinkedIn</a>
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="text-body hover:text-bronze-300 transition-colors w-fit py-2" data-interactive>Twitter (X)</a>
          </div>
        </div>
      </div>
